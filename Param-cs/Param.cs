// Dafny program ParamTests.dfy compiled into C#
...
[assembly: DafnyAssembly.DafnySourceAttribute(@"// Dafny 3.4.1.40215
// Command Line Options: /out:Param.cs /spillTargetCode:3 /compile:0 ParamTests.dfy
// ParamTests.dfy
...
module ParamTests {
  ...
  class CalculatorTests {
    ...
    {
      return [(['a', 'g'], ['j', 'p'], false), (['j'], ['j', 'k'], true)];
    }
...
namespace Param_Compile {
  ...
  public partial class Calculator {
    ...
    public static Dafny.ISequence<char> @add(Dafny.ISequence<char> a, Dafny.ISequence<char> b)
    {
      Dafny.ISequence<char> res = Dafny.Sequence<char>.Empty;
      res = Dafny.Sequence<char>.Concat(a, b);
      return res;
      return res;
    }
    public static bool arrayEqual(BigInteger[] a, BigInteger[] b)
    {
      bool res = false;
      if ((a) == (object) (b)) {
        res = true;
    ...
    public static bool seqPrefix(Dafny.ISequence<char> a, Dafny.ISequence<char> b)
    {
      bool res = false;
      if (Dafny.Sequence<char>.IsProperPrefixOf(a, b)) {
        res = true;
        return res;
      } else {
        res = false;
...
} // end of namespace Param_Compile
...
namespace ParamTests_Compile {
  ...
  public partial class CalculatorTests {
    ...
    public static Dafny.ISequence<_System._ITuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, Dafny.ISequence<char>>> AddSource()
    {
      Dafny.ISequence<_System._ITuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, Dafny.ISequence<char>>> testInputs = Dafny.Sequence<_System._ITuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, Dafny.ISequence<char>>>.Empty;
      testInputs = Dafny.Sequence<_System._ITuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, Dafny.ISequence<char>>>.FromElements(_System.Tuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, Dafny.ISequence<char>>.create(Dafny.Sequence<char>.FromString("a"), Dafny.Sequence<char>.FromString("b"), Dafny.Sequence<char>.FromString("ab")), _System.Tuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, Dafny.ISequence<char>>.create(Dafny.Sequence<char>.FromString("loss"), Dafny.Sequence<char>.FromString("love"), Dafny.Sequence<char>.FromString("losslove")));
      return testInputs;
      return testInputs;
    }
    public static System.Collections.Generic.IEnumerable<object[]> AddSourceConverter(Dafny.ISequence<_System._ITuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, Dafny.ISequence<char>>> dafnyStructure) {
    System.Collections.Generic.List<object[]> newList = new ();
    foreach (var tuple in dafnyStructure.UniqueElements) {
    newList.Add(new object[] {tuple.dtor__0, tuple.dtor__1, tuple.dtor__2});
    }
    return newList;
    }
    public static System.Collections.Generic.IEnumerable<object[]> _AddSource() {
    Dafny.ISequence<_System._ITuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, Dafny.ISequence<char>>> retValue =  AddSource();
    return AddSourceConverter(retValue);
    }
    [Xunit.Theory]
    [Xunit.MemberData(nameof(_AddSource))]
    public void test__add__shouldAddTwoArguments(Dafny.ISequence<char> a, Dafny.ISequence<char> b, Dafny.ISequence<char> expected)
    {
      Dafny.ISequence<char> _64_sum;
      Dafny.ISequence<char> _out0;
      _out0 = Param_Compile.Calculator.@add(a, b);
      _64_sum = _out0;
      Utils_Compile.Assertions.assertEquals<Dafny.ISequence<char>>(expected, _64_sum);
    }
    public static Dafny.ISequence<_System._ITuple3<BigInteger, BigInteger, BigInteger>> MultSource()
    {
      Dafny.ISequence<_System._ITuple3<BigInteger, BigInteger, BigInteger>> testInputs = Dafny.Sequence<_System._ITuple3<BigInteger, BigInteger, BigInteger>>.Empty;
      testInputs = Dafny.Sequence<_System._ITuple3<BigInteger, BigInteger, BigInteger>>.FromElements(_System.Tuple3<BigInteger, BigInteger, BigInteger>.create(new BigInteger(2), new BigInteger(3), new BigInteger(6)), _System.Tuple3<BigInteger, BigInteger, BigInteger>.create(new BigInteger(40), new BigInteger(-2), new BigInteger(-80)), _System.Tuple3<BigInteger, BigInteger, BigInteger>.create(new BigInteger(-7), new BigInteger(-7), new BigInteger(49)));
      return testInputs;
      return testInputs;
    }
    public static System.Collections.Generic.IEnumerable<object[]> MultSourceConverter(Dafny.ISequence<_System._ITuple3<BigInteger, BigInteger, BigInteger>> dafnyStructure) {
    System.Collections.Generic.List<object[]> newList = new ();
    foreach (var tuple in dafnyStructure.UniqueElements) {
    newList.Add(new object[] {tuple.dtor__0, tuple.dtor__1, tuple.dtor__2});
    }
    ...
    public static System.Collections.Generic.IEnumerable<object[]> _MultSource() {
    Dafny.ISequence<_System._ITuple3<BigInteger, BigInteger, BigInteger>> retValue =  MultSource();
    return MultSourceConverter(retValue);
    }
    [Xunit.Theory]
    [Xunit.MemberData(nameof(_MultSource))]
    public void test__mult__shouldMultTwoArguments(BigInteger a, BigInteger b, BigInteger expected)
    {
      BigInteger _65_product;
      BigInteger _out1;
      _out1 = Param_Compile.Calculator.mult(a, b);
      _65_product = _out1;
      Utils_Compile.Assertions.assertEquals<BigInteger>(expected, _65_product);
    }
    public static Dafny.ISequence<_System._ITuple3<BigInteger[], BigInteger[], bool>> ArrayEqualSource()
    {
      Dafny.ISequence<_System._ITuple3<BigInteger[], BigInteger[], bool>> testInputs = Dafny.Sequence<_System._ITuple3<BigInteger[], BigInteger[], bool>>.Empty;
      BigInteger[] _66_a;
      ...
      _nw0[(int)(1)] = new BigInteger(5);
      _66_a = _nw0;
      BigInteger[] _67_b;
      BigInteger[] _nw1 = new BigInteger[Dafny.Helpers.ToIntChecked(Dafny.Helpers.ToIntChecked(new BigInteger(3), "C# arrays may not be larger than the max 32-bit integer"),"C# array size must not be larger than max 32-bit int")];
      _nw1[(int)(0)] = new BigInteger(3);
      _nw1[(int)(1)] = new BigInteger(5);
      _nw1[(int)(2)] = new BigInteger(6);
      _67_b = _nw1;
      testInputs = Dafny.Sequence<_System._ITuple3<BigInteger[], BigInteger[], bool>>.FromElements(_System.Tuple3<BigInteger[], BigInteger[], bool>.create(_66_a, _66_a, true), _System.Tuple3<BigInteger[], BigInteger[], bool>.create(_66_a, _67_b, false));
      return testInputs;
      return testInputs;
    }
    public static System.Collections.Generic.IEnumerable<object[]> ArrayEqualSourceConverter(Dafny.ISequence<_System._ITuple3<BigInteger[], BigInteger[], bool>> dafnyStructure) {
    System.Collections.Generic.List<object[]> newList = new ();
    foreach (var tuple in dafnyStructure.UniqueElements) {
    newList.Add(new object[] {tuple.dtor__0, tuple.dtor__1, tuple.dtor__2});
    }
    ...
    public static System.Collections.Generic.IEnumerable<object[]> _ArrayEqualSource() {
    Dafny.ISequence<_System._ITuple3<BigInteger[], BigInteger[], bool>> retValue =  ArrayEqualSource();
    return ArrayEqualSourceConverter(retValue);
    }
    [Xunit.Theory]
    [Xunit.MemberData(nameof(_ArrayEqualSource))]
    public void test__arrayEqual__shouldCompareTwoArgs(BigInteger[] a, BigInteger[] b, bool expected)
    {
      bool _68_result;
      bool _out2;
      _out2 = Param_Compile.Calculator.arrayEqual(a, b);
      _68_result = _out2;
      Utils_Compile.Assertions.assertEquals<bool>(expected, _68_result);
    }
    public static Dafny.ISequence<_System._ITuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, bool>> SeqPrefixSource()
    {
      Dafny.ISequence<_System._ITuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, bool>> testInputs = Dafny.Sequence<_System._ITuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, bool>>.Empty;
      testInputs = Dafny.Sequence<_System._ITuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, bool>>.FromElements(_System.Tuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, bool>.create(Dafny.Sequence<char>.FromElements('a', 'g'), Dafny.Sequence<char>.FromElements('j', 'p'), false), _System.Tuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, bool>.create(Dafny.Sequence<char>.FromElements('j'), Dafny.Sequence<char>.FromElements('j', 'k'), true));
      return testInputs;
      return testInputs;
    }
    public static System.Collections.Generic.IEnumerable<object[]> SeqPrefixSourceConverter(Dafny.ISequence<_System._ITuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, bool>> dafnyStructure) {
    System.Collections.Generic.List<object[]> newList = new ();
    foreach (var tuple in dafnyStructure.UniqueElements) {
    newList.Add(new object[] {tuple.dtor__0, tuple.dtor__1, tuple.dtor__2});
    }
    ...
    public static System.Collections.Generic.IEnumerable<object[]> _SeqPrefixSource() {
    Dafny.ISequence<_System._ITuple3<Dafny.ISequence<char>, Dafny.ISequence<char>, bool>> retValue =  SeqPrefixSource();
    return SeqPrefixSourceConverter(retValue);
    }
    [Xunit.Theory]
    [Xunit.MemberData(nameof(_SeqPrefixSource))]
    public void test__seqPrefix__shouldSeeIfAIsPrefixOfB(Dafny.ISequence<char> a, Dafny.ISequence<char> b, bool expected)
    {
      bool _69_result;
      bool _out3;
      _out3 = Param_Compile.Calculator.seqPrefix(a, b);
      _69_result = _out3;
      Utils_Compile.Assertions.assertEquals<bool>(expected, _69_result);
    }
  }

} // end of namespace ParamTests_Compile
namespace _module {
