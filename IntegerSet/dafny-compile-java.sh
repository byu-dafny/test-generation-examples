...
MODULENAME=IntegerSet
DOTNET="/usr/local/share/dotnet/dotnet"
DAFNY="${HOME}/.vscode/extensions/correctnesslab.dafny-vscode-2.0.3/out/resources/dafny/Dafny.dll"
...
sed -i                                                                      \
    ...
    src/test/java/${MODULENAME}Tests_Compile/IntegerSetTests.java